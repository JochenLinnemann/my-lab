// based on https://doc.rust-lang.org/rust-by-example/hello/print.html
...
fn main() {
    ...
    // Alternatives
    let formatted_string = format!("{number:>width$}");
    ...
    let pi = 3.141592;
    // see https://doc.rust-lang.org/std/fmt/#precision
...
fn print_debug() {
    //println!("UnPrintable struct: {:?}", UnPrintable(3));
    println!("DebugPrintable struct: {:?}", DebugPrintable(3));
...
// based on https://doc.rust-lang.org/rust-by-example/hello/print/print_display.html
...
struct DispStructure(i32);

// To use the `{}` marker, the trait `fmt::Display` must be implemented
// manually for the type.
impl fmt::Display for DispStructure {
...
fn print_display() {
    println!("This struct `{}` is now printable...", DispStructure(3));
}
